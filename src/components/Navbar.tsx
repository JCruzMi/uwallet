...
export default function Navbar() {
  return (
    <nav className='w-full justify-center flex m-auto sticky top-0 z-50 bg-background/95 backdrop-blur'>
      <div className='flex max-w-6xl w-full justify-between items-center mb-4 px-4'>
